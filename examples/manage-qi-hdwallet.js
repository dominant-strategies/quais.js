...
async function main() {
	...
	console.table(gapAddresses.map((addr) => ({ address: addr.address, index: addr.index, zone: addr.zone, change: addr.change, account: addr.account })));
	...
	console.table(changeAddresses.map((addr) => ({ address: addr.address, index: addr.index, zone: addr.zone, change: addr.change, account: addr.account})));	
