...
export class Typed {
    ...
    /**
     *  Returns whether this is a {@link TypedBigInt | **TypedBigInt**}. 
    ...
    /**
     *  Returns whether this is a {@link TypedData | **TypedData**}. 
     *  If true, a type guard is provided.
     * 
    ...
    /**
     *  Return whether this is a {@link TypedString | **TypedString**}. 
     *  If true, a type guard is provided.
     * 
     ...
     * 
     *  @param {Array<any | Typed>} v - The value to convert to an `array`.
     ...
     * 
     *  @param {Array<any | Typed>} v - The value to convert to a `tuple`.
    ...
    /**
     *  If the value is a {@link Typed | **Typed**} instance, validates the underlying value
     *  and returns it, otherwise returns value directly.
     *
     *  This is useful for functions that with to accept either a {@link Typed | **Typed**}
     *  object or values.
     * 
