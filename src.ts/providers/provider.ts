...
export interface QuaiTransactionRequest {
    ...
    /**
     *  The [EIP-1559](https://eips.ethereum.org/EIPS/eip-1559) maximum 
     *  priority fee to pay per gas.
     */
    maxPriorityFeePerGas?: null | BigNumberish;

    /**
     *  The [EIP-1559](https://eips.ethereum.org/EIPS/eip-1559) maximum 
     *  total fee to pay per gas. The actual value used is protocol 
     *  enforced to be the block's base fee.
     */
    ...
    /**
     *  The [EIP-2930](https://eips.ethereum.org/EIPS/eip-2930) access list. 
     *  Storage slots included in the access list are //warmed// by pre-loading 
     *  them, so their initial cost to fetch is guaranteed, but then each 
     *  additional access is cheaper.
     */
...
/**
 *  A **PreparedTransactionRequest** is identical to a {@link TransactionRequest | **TransactionRequest**}
...
/**
 *  An Interface to indicate a {@link Block | **Block**} has been included in the
...
export class Block implements BlockParams, Iterable<string> {
     ...
     *  into {@link Provider.getBlock | **getBlock**}.
     */
     ...
     *  for all properties on a {@link MinedBlock | **MinedBlock**}.
     * 
...
export class Log implements LogParams {
     ...
     *  {@link Log.getBlock | **Log.getBlock**} to get the {@link Block | **Block**}.
     */
    readonly blockHash!: string;

    /**
     *  The block number of the block this log occurred in. It is preferred
     *  to use the {@link Block.hash | **Block.hash**} when fetching the 
     *  related {@link Block | **Block**}, since in the case of an orphaned 
     ...
     *  efficiently filtered using the {@link Provider.getLogs | **Provider.getLogs**} method.
     */
 ...
 *  block.
 *
 *  The {@link TransactionResponse.isMined | **TransactionResponse.isMined**} can be used to check if the
...
export class QuaiTransactionResponse implements QuaiTransactionLike, QuaiTransactionResponseParams {
     ...
     *  This means the result of executing the {@link QuaiTransactionResponse.data | **data** } will be deployed
     ...
     *  {@link QuaiTransactionResponse.signature | **signature** } using ecrecover.
     */
    readonly from!: string;
     ...
     *  transactions ever sent by {@link QuaiTransactionResponse.from | **from** }.
     */
     ...
     *  {@link QuaiTransactionResponse.getTransaction | **getTransaction**}.
     *
...
//    }
     ...
     *  This is effective only as of the time the TransactionResponse
     *  was instantiated. To get up-to-date information, use
     *  {@link QiTransactionResponse.getTransaction | **getTransaction**}.
     *
     *  This provides a Type Guard that this transaction will have
     *  non-null property values for properties that are null for
     *  unmined transactions.
 ...
 *  to on a {@link Provider| **Provider**}.
 *
 ...
 *
 *  Simulating execution can be used to {@link Provider.call | **call**},
 *  {@link Provider.estimateGas | **estimateGas**} and
 *  {@link Provider.getTransactionResult | **get transaction result**}.
 *
 *  The {@link Provider.broadcastTransaction | **broadcastTransaction**} is the only method which allows updating
...
export interface Provider extends ContractRunner, EventEmitterable<ProviderEvent> {
     ...
     *  it provides a common property on any {@link ContractRunner | **ContractRunner**} that
     ...
     *  `blockTag`, the balance is as of that  {@link BlockTag | **BlockTag**}.
     *
     ...
     *  @returns {Promise<Array<UTXOEntry>>} A promise resolving to the UTXO entries.
     */
     ...
     *  {@link Block | **Block**} object will not need to make remote calls for getting
     *  transactions.
     * 
     *  @param {string} shard - The shard to fetch the block from.
     ...
     *  @returns {Promise<null | TransactionReceipt>} A promise resolving to the transaction receipt or null if not found.
     */
     ...
     *  @returns {Promise<Array<Log>>} A promise resolving to the logs.
     */
