/**
 * A **FallbackProvider** providers resiliance, security and performatnce in a way that is customizable and
 * configurable.
 *
...
/**
 * A **FallbackProvider** manages several [Providers](../classes/Provider) providing resiliance by switching between
 * slow or misbehaving nodes, security by requiring multiple backends to aggree and performance by allowing faster
 * backends to respond earlier.
 *
 * @category Providers
 */
export class FallbackProvider extends AbstractProvider {
     ...
     *
     * If a [Provider](../classes/Provider) is included in `providers`, defaults are used for the configuration.
     */
    constructor(
        ...
        switch (req.method) {
            ...
            case 'call':
                return await provider.call(
                    Object.assign({}, req.transaction as QuaiTransactionRequest, { blockTag: req.blockTag }),
                );
            case 'chainId':
