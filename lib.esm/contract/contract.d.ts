...
declare const Contract_base: new (target: string, abi: InterfaceAbi | Interface, runner?: ContractRunner | null | undefined) => BaseContract & Omit<ContractInterface, keyof BaseContract>;
/**
