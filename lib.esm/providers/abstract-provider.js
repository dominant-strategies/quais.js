...
import { hexlify, isHexString, getBigInt, getNumber, makeError, assert, assertArgument, FetchRequest, toQuantity, defineProperties, EventPayload, resolveProperties, } from "../utils/index.js";
...
export class AbstractProvider {
    ...
    shardBytes(shard) {
        return ShardData.find(it => it.name == shard ||
            it.byte == shard ||
            it.nickname == shard ||
            it.shard == shard)?.byte || '';
    }
