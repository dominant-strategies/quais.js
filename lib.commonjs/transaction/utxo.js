...
function isValidDenomination(denomination) {
    return exports.denominations.includes(denomination);
}
/**
...
function handleBigInt(value, param) {
    ...
    return (0, index_2.getBigInt)(value, param);
}
/**
...
function denominate(value) {
    ...
    for (let i = exports.denominations.length - 1; i >= 0; i--) {
...
class UTXO {
    ...
    set address(value) {
        this.#address = (value == null) ? null : (0, index_1.getAddress)(value);
    }
